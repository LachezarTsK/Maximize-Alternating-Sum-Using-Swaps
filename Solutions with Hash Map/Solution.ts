...
function createMapParentToConnectedComponents(input: number[], unionFind: UnionFind): Map<number, ConnectedComponents> {
...
function calculateMaxAlternatingSum(parentToConnectedComponents: Map<number, ConnectedComponents>): number {
